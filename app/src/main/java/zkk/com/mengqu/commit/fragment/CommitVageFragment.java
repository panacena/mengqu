...
public class CommitVageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFragmentList.add(new PaintCommitFragment());
        mFragmentList.add(new CommitSharesFragment());
        mFragmentList.add(new CommitLeaderboardFragment());
